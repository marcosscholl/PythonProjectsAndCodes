# -*- coding: utf-8 -*-
"""
Created on Mon Jan 13 15:31:08 2014
...
if __name__ == '__main__':
    ...
    av.setWindowFlags(Qt.Qt.WindowStaysOnTopHint);
  
    av.setAttribute(Qt.Qt.WA_NoSystemBackground, True)

    av.setAttribute(Qt.Qt.WA_TranslucentBackground, True)
    av.setAttribute(Qt.Qt.WA_PaintOnScreen)
    #av.setStyleSheet("background-color: transparent;");
    #av.setAutoFillBackground(False)

    av.setWindowFlags(Qt.Qt.FramelessWindowHint)

    #av.setAttribute(Qt.Qt.WA_NoSystemBackground)
    #av.setAttribute(Qt.Qt.WA_OpaquePaintEvent)

   
    # Widget  Transparente
    #av.setWindowOpacity(0.80)

    av.setGeometry(1050, 400, 300, 300)
